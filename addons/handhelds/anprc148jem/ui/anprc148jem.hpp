...
class anprc148jem_radio_dialog {
    ...
    class background: RscBackPicture {
        ...
        x = QUOTE(0.0447031 * safezoneW + safezoneX);
        y = QUOTE(-1.0488 * safezoneH + safezoneY);
        w = QUOTE(0.302156 * safezoneW);
        h = QUOTE(2.0537 * safezoneH);
        moving = 1;
    };
    class enter: HiddenButton {
        idc = IDC_ANPRC148JEM_ENTER;
        x = QUOTE(0.204031 * safezoneW + safezoneX);
        y = QUOTE(0.5352 * safezoneH + safezoneY);
        w = QUOTE(0.0275625 * safezoneW);
    ...
    class edit: RscEditLCD {
        ...
        x = QUOTE(0.163812 * safezoneW + safezoneX);
        y = QUOTE(0.4021 * safezoneH + safezoneY);
        w = QUOTE(0.0634219 * safezoneW);
    ...
    class channel_edit: RscEditLCD {
        ...
        x = QUOTE(0.134422 * safezoneW + safezoneX);
        y = QUOTE(0.402215 * safezoneH + safezoneY);
    ...
    class prev_channel: HiddenButton {
        ...
        x = QUOTE(0.131328 * safezoneW + safezoneX);
        y = QUOTE(0.5319 * safezoneH + safezoneY);
        w = QUOTE(0.023625 * safezoneW);
        h = QUOTE(0.0280062 * safezoneH);
    ...
    class next_channel: HiddenButton {
        ...
        y = QUOTE(0.5341 * safezoneH + safezoneY);
        w = QUOTE(0.0249375 * safezoneW);
        h = QUOTE(0.0280062 * safezoneH);
    ...
    class additional: HiddenButton {
        ...
        x = QUOTE(0.168969 * safezoneW + safezoneX);
        y = QUOTE(0.5011 * safezoneH + safezoneY);
        w = QUOTE(0.0242813 * safezoneW);
    ...
    class speakers: HiddenButton {
        ...
        x = QUOTE(0.132359 * safezoneW + safezoneX);
        y = QUOTE(0.5022 * safezoneH + safezoneY);
        w = QUOTE(0.0269063 * safezoneW);
        h = QUOTE(0.0266059 * safezoneH);
    ...
    class stereo: HiddenButton {
        ...
        x = QUOTE(0.128234 * safezoneW + safezoneX);
    ...
    class volume_Switch: HiddenRotator {
        ...
        x = QUOTE(0.191656 * safezoneW + safezoneX);
        y = QUOTE(0.1139 * safezoneH + safezoneY);
        w = QUOTE(0.045375 * safezoneW);
        h = QUOTE(0.0539 * safezoneH);
    ...
    class channel_Switch: HiddenRotator {
        ...
        x = QUOTE(0.11225 * safezoneW + safezoneX);
        y = QUOTE(0.1458 * safezoneH + safezoneY);
        w = QUOTE(0.0293906 * safezoneW);
