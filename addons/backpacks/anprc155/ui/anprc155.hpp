...
class anprc155_radio_dialog {
    ...
    class background: RscBackPicture {
        ...
        x = QUOTE(0.0869844 * safezoneW + safezoneX);
    ...
    class channel_edit: RscEditLCD {
        ...
        x = QUOTE(0.327 * safezoneW + safezoneX);
    ...
    class edit: RscEditLCD {
        ...
        x = QUOTE(0.374187 * safezoneW + safezoneX);
        y = QUOTE(0.3416 * safezoneH + safezoneY);
    ...
    class enter: HiddenButton {
        ...
        y = QUOTE(0.5066 * safezoneH + safezoneY);
        w = QUOTE(0.0185625 * safezoneW);
        h = QUOTE(0.0209 * safezoneH);
        tooltip = ECSTRING(core,set_frequency);
        onButtonClick = QUOTE([((ctrlParent (_this select 0))) displayCtrl IDC_ANPRC155_EDIT] call TFAR_backpacks_fnc_onButtonClick_Enter;);
        action = "";
    };
    class clear: HiddenButton {
        idc = IDC_ANPRC155_CLEAR;
        x = QUOTE(0.408781 * safezoneW + safezoneX);
        y = QUOTE(0.473394 * safezoneH + safezoneY);
        w = QUOTE(0.0180469 * safezoneW);
    ...
    class prev_channel: HiddenButton {
        ...
        x = QUOTE(0.362844 * safezoneW + safezoneX);
        y = QUOTE(0.537808 * safezoneH + safezoneY);
        w = QUOTE(0.02625 * safezoneW);
    ...
    class next_channel: HiddenButton {
        ...
        x = QUOTE(0.362844 * safezoneW + safezoneX);
        y = QUOTE(0.470593 * safezoneH + safezoneY);
        w = QUOTE(0.0249375 * safezoneW);
    ...
    class volume_Switch: HiddenRotator {
        ...
        x = QUOTE(0.224656 * safezoneW + safezoneX);
        y = QUOTE(0.2987 * safezoneH + safezoneY);
        w = QUOTE(0.0458906 * safezoneW);
        h = QUOTE(0.0836 * safezoneH);
    ...
    class stereo: HiddenButton {
        ...
        y = QUOTE(0.5363 * safezoneH + safezoneY);
        w = QUOTE(0.0180469 * safezoneW);
    ...
    class additional: HiddenButton {
        ...
        x = QUOTE(0.315406 * safezoneW + safezoneX);
        y = QUOTE(0.5055 * safezoneH + safezoneY);
        w = QUOTE(0.0190781 * safezoneW);
        h = QUOTE(0.0275 * safezoneH);
    ...
    class speakers: HiddenButton {
        ...
        x = QUOTE(0.408219 * safezoneW + safezoneX);
        y = QUOTE(0.5374 * safezoneH + safezoneY);
        w = QUOTE(0.0190781 * safezoneW);
        h = QUOTE(0.0242 * safezoneH);
