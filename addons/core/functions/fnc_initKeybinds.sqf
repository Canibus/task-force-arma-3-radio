...
["TFAR", "CycleSRRadiosNext", [localize LSTRING(key_CycleNextSRRadios), localize LSTRING(key_CycleNextSRRadios)], {true}, {["next"] call TFAR_fnc_processSWCycleKeys}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleSRRadiosPrev", [localize LSTRING(key_CyclePrevSRRadios), localize LSTRING(key_CyclePrevSRRadios)], {true}, {["prev"] call TFAR_fnc_processSWCycleKeys}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadiosNext", [localize LSTRING(key_CycleNextLRRadios), localize LSTRING(key_CycleNextLRRadios)], {true}, {["next"] call TFAR_fnc_processLRCycleKeys}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadiosPrev", [localize LSTRING(key_CyclePrevLRRadios), localize LSTRING(key_CyclePrevLRRadios)], {true}, {["prev"] call TFAR_fnc_processLRCycleKeys}, [], false] call cba_fnc_addKeybind;

["TFAR", "CycleSRRadioChannelNext", [localize LSTRING(key_CycleNextSRChannel), localize LSTRING(key_CycleNextSRChannel)], {true}, {[1, false] call TFAR_fnc_setChannelViaDialog;}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleSRRadioChannelPrev", [localize LSTRING(key_CyclePrevSRChannel), localize LSTRING(key_CyclePrevSRChannel)], {true}, {[0, false] call TFAR_fnc_setChannelViaDialog;}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadioChannelNext", [localize LSTRING(key_CycleNextLRChannel), localize LSTRING(key_CycleNextLRChannel)], {true}, {[1, true] call TFAR_fnc_setChannelViaDialog;}, [], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadioChannelPrev", [localize LSTRING(key_CyclePrevLRChannel), localize LSTRING(key_CyclePrevLRChannel)], {true}, {[0, true] call TFAR_fnc_setChannelViaDialog;}, [], false] call cba_fnc_addKeybind;
