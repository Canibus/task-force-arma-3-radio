...
class fadak_radio_dialog {
    ...
    onLoad = QUOTE(if (sunOrMoon < 0.2) then { \
        ((_this select 0) displayCtrl TF_IDD_BACKGROUND) ctrlSetText 'PATHTOF(fadak\ui\fadak_n.paa)';};);
    controls[]= {
        QUOTE(background),
        QUOTE(enter),
        QUOTE(clear),
    ...
    class background: RscBackPicture {
        ...
        x = QUOTE(0.0142813 * safezoneW + safezoneX);
        y = QUOTE(-0.1314 * safezoneH + safezoneY);
        w = QUOTE(0.332062 * safezoneW);
        h = QUOTE(1.1198 * safezoneH);
        moving = 1;
    };
    class enter: HiddenButton {
        idc = IDC_FADAK_ENTER_FADAK;
        x = QUOTE(0.196812 * safezoneW + safezoneX);
        y = QUOTE(0.577 * safezoneH + safezoneY);
        w = QUOTE(0.0170625 * safezoneW);
    ...
    class clear: HiddenButton {
        idc = IDC_FADAK_CLEAR;
        x = QUOTE(0.196812 * safezoneW + safezoneX);
        y = QUOTE(0.6078 * safezoneH + safezoneY);
        w = QUOTE(0.0150938 * safezoneW);
    ...
    class additional: HiddenButton {
        ...
        x = QUOTE(0.196297 * safezoneW + safezoneX);
        y = QUOTE(0.643 * safezoneH + safezoneY);
        w = QUOTE(0.0164063 * safezoneW);
        h = QUOTE(0.0238053 * safezoneH);
    ...
    class previous_channel: HiddenButton {
        ...
        x = QUOTE(0.196297 * safezoneW + safezoneX);
        y = QUOTE(0.6749 * safezoneH + safezoneY);
        w = QUOTE(0.0150938 * safezoneW);
        h = QUOTE(0.022405 * safezoneH);
    ...
    class increase_volume: HiddenButton {
        ...
        x = QUOTE(0.176187 * safezoneW + safezoneX);
        y = QUOTE(0.6738 * safezoneH + safezoneY);
        w = QUOTE(0.0164063 * safezoneW);
        h = QUOTE(0.0252056 * safezoneH);
    ...
    class decrease_volume: HiddenButton {
        ...
        x = QUOTE(0.137 * safezoneW + safezoneX);
        y = QUOTE(0.6727 * safezoneH + safezoneY);
        w = QUOTE(0.0164063 * safezoneW);
        h = QUOTE(0.0252056 * safezoneH);
    ...
    class edit: RscEditLCD {
        idc = IDC_FADAK_EDIT;
        x = QUOTE(0.162781 * safezoneW + safezoneX);
        y = QUOTE(0.401 * safezoneH + safezoneY);
        w = QUOTE(0.0505312 * safezoneW);
    ...
    class channel_edit: RscEditLCD {
        ...
        x = QUOTE(0.140094 * safezoneW + safezoneX);
        y = QUOTE(0.401 * safezoneH + safezoneY);
    ...
    class stereo: HiddenButton {
        ...
        x = QUOTE(0.157625 * safezoneW + safezoneX);
        y = QUOTE(0.6738 * safezoneH + safezoneY);
        w = QUOTE(0.0164063 * safezoneW);
        h = QUOTE(0.0252056 * safezoneH);
        action = QUOTE( \
    ...
    class channel_switch: HiddenRotator {
        ...
        x = QUOTE(0.167937 * safezoneW + safezoneX);
        y = QUOTE(0.2624 * safezoneH + safezoneY);
        w = QUOTE(0.0236227 * safezoneW);
        h = QUOTE(0.0518116 * safezoneH);
    ...
    class speakers: HiddenButton {
        ...
        x = QUOTE(0.156078 * safezoneW + safezoneX);
        y = QUOTE(0.61 * safezoneH + safezoneY);
        w = QUOTE(0.0175312 * safezoneW);
